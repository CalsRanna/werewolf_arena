...
void main() {
  group('GameConfig Tests', () {
    test('GameConfig基本构造和属性访问', () {
      ...
      expect(config.playerIntelligences[0].baseUrl, equals('https://api.openai.com/v1'));
    ...
    test('defaultIntelligence属性测试', () {
      ...
      expect(configWithIntelligences.defaultIntelligence, equals(intelligence1));
      
      // 测试空智能配置的情况
      final emptyConfig = GameConfig(
        playerIntelligences: [],
        maxRetries: 3,
      );
...
''');
      ...
      try {
        ...
        expect(defaultIntelligence.baseUrl, equals('https://api.openai.com/v1'));
        ...
        expect(secondIntelligence.baseUrl, equals('https://api.anthropic.com/v1'));
