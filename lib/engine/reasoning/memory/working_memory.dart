...
class WorkingMemory {
  ...
  factory WorkingMemory.fromJson(Map<String, dynamic> json) {
    return WorkingMemory(
      ...
      identityEstimates:
          (json['identityEstimates'] as Map<String, dynamic>?)?.map(
            (k, v) => MapEntry(k, IdentityEstimate.fromJson(v)),
          ) ??
          {},
      keyFacts:
          (json['keyFacts'] as List?)
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'identityEstimates': identityEstimates.map(
...
class KeyFact {
  ...
  Map<String, dynamic> toJson() {
    return {'description': description, 'importance': importance, 'day': day};
  }
}
