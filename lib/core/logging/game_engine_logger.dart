...
class GameEngineLogger {
  ...
  void debug(
    ...
    _observer?.onGameLog(GameLogEvent.debug(
      category,
      message,
      phase: _currentPhase,
  ...
  void info(
    ...
    _observer?.onGameLog(GameLogEvent.info(
      category,
      message,
      phase: _currentPhase,
      dayNumber: _currentDay,
  ...
  void warning(
    ...
    _observer?.onGameLog(GameLogEvent.warning(
      category,
      message,
      phase: _currentPhase,
      dayNumber: _currentDay,
  ...
  void error(
    ...
    _observer?.onGameLog(GameLogEvent.error(
      category,
      message,
      phase: _currentPhase,
      dayNumber: _currentDay,
